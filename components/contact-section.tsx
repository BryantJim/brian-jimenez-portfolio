...
const contactInfo = [
  { icon: Mail, value: "Jimenezbrian588@outlook.com", href: "mailto:Jimenezbrian588@outlook.com" },
  { icon: Phone, value: "+1 (829) 458-7954", href: "tel:+18294587954" },
  { icon: MapPin, value: "San Francisco de Macorís, DR", href: null },
];

const socialLinks = [
  { icon: Github, label: "GitHub", href: "https://github.com/BryantJim", username: "BryantJim" },
  { icon: Linkedin, label: "LinkedIn", href: "https://www.linkedin.com/in/anthony-brian-jiménez-lópez-3a2878230", username: "anthony-brian-jiménez-lópez" },
];
      ...
      <div className="container">
        ...
        <div className="grid gap-8 lg:grid-cols-2">
            ...
            <div className="space-y-4">
              {contactInfo.map((item, i) => (
                ...
                >
                  ...
                  <div>
                    <p className="text-xs text-muted-foreground">{t.contact.infoLabels[i]}</p>
                    {item.href ? (
              ...
              {socialLinks.map((link) => (
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="font-mono text-sm text-foreground">@{link.username}</p>
                  </div>
                </a>
              ))}
            </div>
            ...
            <div className="overflow-hidden rounded-xl border border-border bg-card/50 backdrop-blur-sm">
              ...
              <div className="p-4 font-mono text-sm">
                <div className="space-y-2">
                  <p><span className="text-primary">$</span> <span className="text-cyan">whoami</span></p>
                  <p className="text-muted-foreground">anthony-brian-jimenez-lopez</p>

                  <p className="mt-4"><span className="text-primary">$</span> <span className="text-cyan">cat</span> current_role.txt</p>
                  <p className="text-muted-foreground">{t.contact.terminalRole}</p>

                  <p className="mt-4"><span className="text-primary">$</span> <span className="text-cyan">echo</span> $STATUS</p>
                  <p className="text-chart-2">{t.contact.terminalStatus}</p>

                  <p className="mt-4"><span className="text-primary">$</span> <span className="animate-pulse">_</span></p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="relative overflow-hidden rounded-xl border border-border bg-card/30 p-6 backdrop-blur-sm sm:p-8">
            ...
            <h3 className="mb-6 text-xl font-semibold text-foreground">{t.contact.sendMessage}</h3>
            ...
            {submitted ? (
              <div className="flex flex-col items-center justify-center py-12 text-center">
                ...
                <h4 className="mb-2 text-lg font-semibold text-foreground">{t.contact.successTitle}</h4>
